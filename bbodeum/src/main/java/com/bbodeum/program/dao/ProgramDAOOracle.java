...
public class ProgramDAOOracle implements ProgramDAO {
	...
	@Override
	public List<Program> selectByTrAndKeyAndDy(String trId, Integer keyId, String dy, int start, int end)
...
//			System.out.println(list);
	...
	public static void main(String[] args) throws FindException {
		...
		List<Program> list = dao.selectByTrAndKeyAndDy("T0000", 100, null, 1, 5);
		for(Program p :list) {
